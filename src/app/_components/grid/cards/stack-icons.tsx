...
import { XCodeIcon } from '~/components/icons/svgs/xcode'
...
export const stackLines: StackLine = {
  ...
  middle: [
    // { title: 'Obsidian', icon: ObsidianIcon, color: '#7C3AED' },
    { title: 'Notion', icon: NotionIcon, color: '' },
    { title: 'ObsidianNew', icon: ObsidianNewIcon, color: '.' },
    { title: 'Copilot', icon: CopilotIcon, color: '.' },
    { title: 'XCode', icon: XCodeIcon, color: '.' },
    { title: 'Arch', icon: ArchIcon, color: '.' },
    { title: 'Telegram', icon: TelegramIcon, color: '.' }
    // { title: 'Mullvad', icon: MullvadIcon, color: '.' }
  ],
  bottom: [
