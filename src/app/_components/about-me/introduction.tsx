...
export function Introduction() {
  return (
    <div className="flex-1 space-y-4">
      ...
      <p>
        Former full time INTP & current INTJ & part time ISTP whom is caffein
        overdosed hyperboosted by Monster meanwhile an egoistic capitalist that
        overthinks ;) work with technologies from the{' '}
        <span>
