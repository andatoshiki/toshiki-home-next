...
export function ToggleTheme() {
  ...
  return (
    <Menu as="div" className="relative inline-flex items-center">
      ...
      <Menu.Items
        as="div"
        className="absolute right-0 top-10 z-[130] origin-top-right animate-fade-down rounded-xl bg-neutral-50 p-1 outline-none animate-duration-300 dark:bg-neutral-950"
      >
