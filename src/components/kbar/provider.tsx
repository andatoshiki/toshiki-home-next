  ...
  const personalLinksActions: Action[] = [
    {
      ...
      perform: () =>
        window.open('https://github.com/andatoshiki/dotfiles', '_blank')
    },
    {
      id: 'out-bookshelf',
      name: 'My Bookshelf',
  ...
  const websiteInformationActions: Action[] = [
    {
      ...
      perform: () =>
        window.open('https://github.com/andatoshiki/mateusf.com', '_blank')
    },
    {
      id: 'out-license',
      name: 'License',
      ...
      perform: () =>
        window.open(
          'https://github.com/andatoshiki/mateusf.com/blob/main/LICENSE',
          '_blank'
        )
    },
    {
